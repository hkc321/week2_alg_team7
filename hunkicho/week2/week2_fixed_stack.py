...
class FixedStack:
    ...
    class Empty(Exception):
        """비어 있는 FixedStack에 pop 또는 peek할 때 내보내는 예외 처리"""
        pass
    ...
    def __init__(self, capacity: int = 256) -> None:
        """stack 초기화"""
        self.stk = [None] * capacity   # stk -> 스택 본체
    ...
    def peek(self) -> Any:
        """스택에서 데이터를 peek(꼭대기에서 데이터를 들여다봄)"""
